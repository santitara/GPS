...
void DRV_OC0_Initialize(void)
{
    ...
    PLIB_OC_Buffer16BitSet(OC_ID_1, 32768);
    PLIB_OC_PulseWidth16BitSet(OC_ID_1, 16384);
}
void DRV_OC_Set_Freq(uint16_t  frequency){   //PARA PRESCALER DE 256 65535->0.4Kmh 1115->25Kmh aprox
    DRV_TMR2_PeriodValueSet(frequency);
    PLIB_OC_PulseWidth16BitSet(OC_ID_1, frequency/2); //set duty
    PLIB_OC_Buffer16BitSet(OC_ID_1, frequency/2);
}
